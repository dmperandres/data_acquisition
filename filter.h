...
namespace _f_filter_ns
{
  ...
  {FILTER_RETINEX_C,{"<b>Retinex C</b>","<p>This filter applies a local contrast with Retinex C</p><p><b>Input:</b> <font color='#ff0000' font size=4>Color image</p><p><b>Output:</b> Grayscale image</p>"}},
...
//  _f_filter_ns::_type_filter type_filter(){return Type_filter;}
  ...
  void input_changed(bool Input_changed1){Input_changed=Input_changed1;}
...
//  virtual bool use_dots()=0;
  ...
  cv::Mat *Input_image_0=nullptr;
  cv::Mat *Output_image_0=nullptr;
  cv::Mat *Input_image_1=nullptr;
